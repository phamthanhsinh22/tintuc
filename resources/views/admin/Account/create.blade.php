                    ...
                    <div class="card-body">
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="{{ route('account.store') }}" id="myTable" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password" class="form-control" id="exampleInputEmail1" value="{{old('password')}}"
                                            placeholder="Vui lòng nhập...">
