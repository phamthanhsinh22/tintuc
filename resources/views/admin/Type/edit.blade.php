                    ...
                    <div class="card-body">
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="{{ route('type.update', $data->id,) }}" id="myTable"
                                    method="post">
                                    {{csrf_field()}}
                                    {{ method_field('PUT') }}
                                    <div class="form-group">
                                        ...
                                        <input type="text" onkeyup="ChangeToSlug()" id="slug" name="type_name" class="form-control" id="exampleInputEmail1"
                                            value="{{ $data->typName }}">
                                        <label for="exampleInputEmail1">Nhập slugType</label>
                                        <input type="text" id="convert_slug" name="slugType" class="form-control" id="exampleInputEmail1"
                                            value="{{ $data->slug_typ }}">
                                        <label for="exampleInputEmail1">Active</label>
                                        <select class="form-control fh5co_text_select_option" name="Active"
                                            id="exampleInputEmail1">
                                            <option>{{$data->Active}}</option>
                                            @if($data->Active==0)
